...
import { Edit2, Plus, Search, Moon, Sun, X, Upload } from 'lucide-react';
        ...
        {currentTab === 'teams' && (
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: spacing.lg }}>
              <h3 style={{ margin: 0, fontSize: typography.fontSize['2xl'], fontWeight: typography.fontWeight.bold }}>Teams</h3>
              {isOfficial && (
...
export default GrapplingTournamentApp;